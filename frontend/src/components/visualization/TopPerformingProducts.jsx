...
import { useGetTopPerformingProductsQuery } from "../../api/analyticsApi/performanceApi";
import {
  BarChart,
  Bar,
  XAxis,
...
const TopPerformingProducts = React.memo(() => {
  ...
  const { data, isLoading, error } = useGetTopPerformingProductsQuery();
  ...
  return (
    <ResponsiveContainer width="100%" height="100%">
      ...
      >
        ...
        <Tooltip
          content={
            <CustomTooltip label1="Product Revenue" label2="Quantity Sold" />
          }
